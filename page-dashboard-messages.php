              ...
              <div class="extra-dashboard-menu dn-lg">
                <div class="ed_menu_list">
                  <ul>
                    ...
                    <li><a href="page-dashboard-profile.php"><span class="flaticon-user-2"></span>Profile</a></li>
                    ...
                    <li><a class="active" href="page-dashboard-messages.html"><span class="flaticon-message"></span>Messages</a></li>
                ...
                <div class="inbox_user_list">
                  ...
                  <ul>
                    <li class="contact pt3">
                      <a href="#">
                        <div class="wrap">
                          <img class="img-fluid" src="Src/Assets/images/team/ms1.jpg" alt="ms1.jpg"/>
                    ...
                    <li class="contact">
                      <a href="#">
                        <div class="wrap">
                          <img class="img-fluid" src="Src/Assets/images/team/ms2.jpg" alt="ms2.jpg"/>
                          <div class="child-wrap df">
                            <div class="meta">
                    ...
                    <li class="contact">
                      <a href="#">
                        <div class="wrap">
                          <img class="img-fluid" src="Src/Assets/images/team/ms3.jpg" alt="ms3.jpg"/>
                          <div class="child-wrap df">
                            <div class="meta">
                    ...
                    <li class="contact">
                      <a href="#">
                        <div class="wrap">
                          <img class="img-fluid" src="Src/Assets/images/team/ms4.jpg" alt="ms4.jpg"/>
                          <div class="child-wrap df">
                            <div class="meta">
                    ...
                    <li class="contact">
                      <a href="#">
                        <div class="wrap">
                          <img class="img-fluid" src="Src/Assets/images/team/ms5.jpg" alt="ms5.jpg"/>
                          <div class="child-wrap df">
                            <div class="meta">
                    ...
                    <li class="contact">
                      <a href="#">
                        <div class="wrap">
                          <img class="img-fluid" src="Src/Assets/images/team/ms6.jpg" alt="ms6.jpg"/>
                          <div class="child-wrap df">
                            <div class="meta">
                    ...
                    <li class="contact">
                      <a href="#">
                        <div class="wrap">
                          <img class="img-fluid" src="Src/Assets/images/team/ms7.jpg" alt="ms7.jpg"/>
                          <div class="child-wrap df">
                            <div class="meta">
                    ...
                    <li class="contact">
                      <a href="#">
                        <div class="wrap">
                          <img class="img-fluid" src="Src/Assets/images/team/ms8.jpg" alt="ms8.jpg"/>
                          <div class="child-wrap df">
                            <div class="meta">
              ...
              <div class="message_container mt30-md">
                <div class="user_heading">
                  <div class="wrap">
                    ...
                    <img class="img-fluid mr10" src="Src/Assets/images/team/mm1.jpg" alt="mm1.jpg"/>
                    <div class="meta">
                ...
                <div class="inbox_chatting_box">
                  <ul class="chatting_content">
                    <li class="sent">
                      <div class="df">
                        <img class="img-fluid align-self-start me-3" src="Src/Assets/images/team/mm2.jpg" alt="mm2.jpg"/>
                    ...
                    <li class="reply first">
                      <div class="df justify-content-end">
                        ...
                        <img class="img-fluid align-self-end ms-3" src="Src/Assets/images/team/mm3.jpg" alt="mm3.jpg"/>
                      </div>
                      <p>Hey there, we’re just writing to let you know that you’ve been subscribed to a repository on GitHub.</p>
                    </li>
                    <li class="sent">
                      <div class="df">
                        <img class="img-fluid align-self-start me-3" src="Src/Assets/images/team/mm3.jpg" alt="mm3.jpg"/>
                        <h5 class="title">Albert Flores <small class="body-color ml15">35 mins</small></h5>
                      </div>
                      <p>Ok, Understood!</p>
                    </li>
...
<script src="Src/Assets/js/chart-custome.js"></script>
...
<!-- Mirrored from creativelayers.net/themes/voiture-html/page-dashboard-messages.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jun 2022 11:45:16 GMT -->
</html>