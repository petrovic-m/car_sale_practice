...
<!-- Agent Single Grid View -->
  <section class="our-agent-single bgc-f9 pb90 inner_page_section_spacing mt70-992">
    <div class="container">
      <div class="row mb30">
        <div class="col-xl-12">
      ...
      <div class="row mb60">
        <div class="col-lg-8 col-xl-8">
          <div class="user_profile_details">
            <div class="d-flex db-414 align-items-center">
              <div class="flex-shrink-0 mb15-414">
                <img class="seller_img" src="Src/Assets/images/team/seller.png" alt="seller.png">
              </div>
              <div class="flex-grow-1 ms-3">
                <h2 class="mt-0 title">Volvo Cars Istanbul</h2>
                <ul class="prop_details mb0">
                  <li class="list-inline-item"><a class="mr10" href="#"><span class="flaticon-phone-call pr5 vam"></span> <span class="tdu">(302) 555-0107</span></a></li>
                  <li class="list-inline-item"><a class="mr10" href="#"><span class="fas fa-map-marker-alt pr5 vam"></span> 3891 Ranchview Dr. Richardson, California 62639</a></li>
                  <li class="list-inline-item"><a class="mr10" href="#"><span class="flaticon-email pr5 vam"></span> hello@voiture.com</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-xl-4">
          <div class="user_profile_details">
            <div class="text-end">
              <button class="btn btn-thm btn-block view_car_btn">View 250 cars</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="user_profile_service">
                ...
                <div class="row">
                  <div class="col-lg-4 col-xl-5">
                    <h5 class="subtitle">Onsite facilities</h5>
                  </div>
                  <div class="col-lg-4 col-xl-3">
                    <ul class="service_list">
                      <li>Home delivery</li>
            ...
            <div class="col-lg-12">
              <div class="single_product_grid user_profile">
                <div class="single_product_slider vertical_style nav_none">
                  <div class="item">
                    <div class="sps_content">
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb"><img class="img-fluid" src="Src/Assets/images/shop/ss1.jpg" alt="ss1.jpg"></div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="sps_content">
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb"><img class="img-fluid" src="Src/Assets/images/shop/ss2.jpg" alt="ss2.jpg"></div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                      </div>
                  ...
                  <div class="item">
                    <div class="sps_content">
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb"><img class="img-fluid" src="Src/Assets/images/shop/ss3.jpg" alt="ss3.jpg"></div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                      </div>
                  ...
                  <div class="item">
                    <div class="sps_content">
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb"><img class="img-fluid" src="Src/Assets/images/shop/ss4.jpg" alt="ss4.jpg"></div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                      </div>
                  ...
                  <div class="item">
                    <div class="sps_content">
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb"><img class="img-fluid" src="Src/Assets/images/shop/ss5.jpg" alt="ss5.jpg"></div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                      </div>
            ...
            <div class="col-lg-12">
              <div class="user_profile_review mt30">
                  ...
                  <div class="mbp_pagination_comments">
                    <div class="mbp_first d-flex db-414">
                      <div class="flex-shrink-0">
                        <img src="Src/Assets/images/blog/reviewer1.png" class="mr-3" alt="reviewer1.png">
                      </div>
                    ...
                    <div class="mbp_first d-flex db-414">
                      <div class="flex-shrink-0">
                        <img src="Src/Assets/images/blog/reviewer2.png" class="mr-3" alt="reviewer2.png">
                      </div>
                      <div class="flex-grow-1 ms-4 ml0-414">
                        <h4 class="sub_title">Jane Cooper</h4>
                        <div class="sspd_postdate mb15">April 6, 2021 at 3:21 AM
              ...
              <div class="wrapper">
                ...
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    ...
                    <span class="schedule">10:00 - 17:00</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="me-auto">
  ...
  <section class="our-shop pb100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="popular_listing_sliders user_profile row">
            <div class="nav nav-tabs col-lg-12 justify-content-start" role="tablist">
              <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Used cars (93)</button>
              <button class="nav-link" id="nav-shopping-tab" data-bs-toggle="tab" data-bs-target="#nav-shopping" role="tab" aria-controls="nav-shopping" aria-selected="false">Used cars (93)</button>
            </div>
...
<script src="Src/Assets/js/googlemaps1.js"></script>
<!-- Custom script for all pages --> 
<script src="Src/Assets/js/script.js"></script>
</body>

<!-- Mirrored from creativelayers.net/themes/voiture-html/page-user-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jun 2022 11:45:19 GMT -->
</html>