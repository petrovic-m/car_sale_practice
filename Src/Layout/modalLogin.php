                    ...
                    <div class="row mt30 tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="col-lg-12">
                            <div class="login_form">
                                <p>New to Cars.com? <a href="page-register.php">Sign up.</a> Are you a dealer?</p>
                                <form action="Src/init.php" method="POST">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-log btn-thm mt5">Sign in</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="row mt30 tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="col-lg-12">
                            <div class="sign_up_form">
                                <p>Already have a profile? <a href="page-login.php">Sign in.</a></p>
                                <form action="Src/init.php" method="post">
                                    <div class="row">
                                        <div class="col-lg-6">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-signup btn-thm mb0">Sign Up</button>
                                </form>
                            </div>
                        </div>
                    </div>
