...
<head>
    ...
    <!-- Favicon -->
    <link href="Src/Assets/images/favicon.ico" sizes="128x128" rel="shortcut icon" type="image/x-icon" />
    <link href="Src/Assets/images/favicon.ico" sizes="128x128" rel="shortcut icon" />
